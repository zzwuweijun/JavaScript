$(function () {
    ...
    $('#photo dl dt img').click(function () {
        ...
        $(temp_img).bind('load', function () {
            $('#photo_big .big img').attr('src', temp_img.src).animate({
                ...
                t : 30,
                step : 10
            }).css('width', '620px').css('height', '460px').css('top', 0).opacity(0);
        });
    ...
    $('#photo_big .big .left').click(function () {
        ...
        $(current_img).bind('load', function () {
            $('#photo_big .big img').attr('src', current_img.src).animate({
                ...
                t : 30,
                step : 10
            }).opacity(0).css('width', '620px').css('height', '460px').css('top', 0);
        });
    ...
    // ajax({
    //     url:"http://localhost:63342/review/JavaScript/%E9%A1%B9%E7%9B%AE_%E5%8D%9A%E5%AE%A2%E5%89%8D%E7%AB%AF/%E5%8D%9A%E5%AE%A2%E5%89%8D%E7%AB%AF%E9%A1%B9%E7%9B%AE_%E5%B0%81%E8%A3%85%E5%BA%93_027%E5%BC%95%E5%85%A5Ajax/test.json",
    //     method:"get",
    //     async:false,
    //     success:function(data){
    //         alert(data);
    //         alert(JSON.parse(data));
    //         alert(JSON.parse(data)[1]["ieji"]);
    //     }
    // })
});
